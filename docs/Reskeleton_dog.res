...
addToCategory("Reskeleton", ({addDog}) => {
  addDog("Default", _ =>
      ...
      <div className=Styles_doc.wrapperTextSkeleton>
        ...
        <div
          style={ReactDOM.Style.make(
            ~fontSize={
              `${int("font size", {min: 0, max: 100, initial: 30, step: 1})->Belt.Int.toString}px`
            },
            (),
          )}>
  ...
  addDog("Usage Samples", _ =>
    <div className=Styles_doc.wrapperDefault>
      <div>
        <div className=Styles_doc.profileWrapper>
          <Reskeleton className=Styles_doc.avatar width="50px" height="50px" borderRadius="50%" />
          <div>
